...
bc[0xde]=DEC_absx;
*/
void DEC_z(unsigned char a1, unsigned char a2)
{
...
void DEC_zx(unsigned char a1, unsigned char a2)
{
...
void DEC_abs(unsigned char a1, unsigned char a2)
{
...
void DEC_absx(unsigned char a1, unsigned char a2)
{
